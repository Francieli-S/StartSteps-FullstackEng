...
-- SELECT COUNT(*) AS total_flights FROM Flights;
-- SELECT COUNT(*) AS flights FROM Flights WHERE price > 300;
-- SELECT SUM(price) AS total_sum FROM Flights;
-- SELECT SUM(price) AS total_sum_less400 FROM Flights WHERE price < 400;

-- SELECT AVG(price) FROM Flights;
-- SELECT AVG(price) FROM Flights WHERE price > 400;
-- SELECT AVG(price) FROM Flights WHERE price <= 350;
...
SELECT Users.name, Bookings.booking_id, Bookings.booking_date
FROM Users
